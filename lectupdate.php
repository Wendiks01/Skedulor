        ...
        <div class="student-info">
            ...
            <div class="student-details">
                <form>
                    ...
                    <p><strong>Matricule:</strong> <input type="text" name="matricule"></p>
                    <p><strong>Courses:</strong> <input type="text" name="matricule"></p>
                    <p><strong>Level/Class:</strong> <input type="text" name="level"></p>
                    <p><strong>Image:</strong> <input type="file" name="image"></p>
                    <p><strong>Available Time:</strong> <input type="time" name="available_time"></p>
                </form>
